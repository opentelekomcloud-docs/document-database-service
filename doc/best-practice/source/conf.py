...
project = 'Document Database Service'
otcdocs_repo_name = 'opentelekomcloud-docs/document-database-service'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/document-database-service/best-practice/'
...
html_title = "Document Database Service - Best Practice"
